...
// Create backup
const backupPath = './finalComponentList_before_countermeasures_correct_fix.csv';
...
for (let i = 1; i < componentLines.length; i++) {
    ...
    // The issue is that ProductionSteps (column 10) currently has an ingredient
    // We need to fix this by properly setting ProductionSteps and then ingredients

    // Set ProductionSteps (column 10) to the correct count
